...
class RankNet151(torch.nn.Module):
    def __init__(self):
        super(RankNet151, self).__init__()
        # Visual_FC
    ...
    def forward(self, x_visual1, x_audio1, x_text1, x_visual2, x_audio2, x_text2):
        ...
        # Fusion
        y_ctr1_l1 = F.relu(self.fusion_fc_ly1(y_weight_emb1_visual))
        ...
        # Fusion
        y_ctr2_l1 = F.relu(self.fusion_fc_ly1(y_weight_emb2_visual))
