...
class RankNet13(torch.nn.Module):
    def __init__(self):
        super(RankNet13, self).__init__()
        # Visual_FC
        ...
        # Fusion_FC
        self.fusion_fc_ly1 = torch.nn.Linear(384, 256)
        self.fusion_fc_ly2 = torch.nn.Linear(256, 128)
        self.fusion_fc_ly3 = torch.nn.Linear(128, 64)
        self.fusion_fc_ly4 = torch.nn.Linear(64, 32)
        self.fusion_fc_ly5 = torch.nn.Linear(32, 16)
        self.fusion_fc_ly6 = torch.nn.Linear(16, 1)
    ...
    def forward(self, x_visual1, x_audio1, x_text1, x_visual2, x_audio2, x_text2):
        ...
        y_connect_embedding1 = torch.cat([y_weight_emb1_visual, y_weight_emb1_audio, y_weight_emb1_text], dim=1)
        ...
        y_ctr1_l5 = F.relu(self.fusion_fc_ly5(y_ctr1_l4))
        y_ctr1 = self.fusion_fc_ly6(y_ctr1_l5)
        ...
        # Connect visual/audio-embedding1 1*256
        y_connect_embedding2 = torch.cat([y_weight_emb2_visual, y_weight_emb2_audio, y_weight_emb2_text], dim=1)
        ...
        y_ctr2_l5 = F.relu(self.fusion_fc_ly5(y_ctr2_l4))
        y_ctr2 = self.fusion_fc_ly6(y_ctr2_l5)
