...
from Dataset.Dataset_pair_train import MyDatasetTrain
from Dataset.Dataset_pair_val import MyDatasetVal

from model.RankNet_version9_5 import RankNet, init_weights
from model.JapanModel_version0 import RankNetJapan, init_weights
...
def main():
    ...
    # Train-Data
    my_dataset = MyDatasetTrain("./Dataset-CSV/Snap_Train_CTR_label_pair.csv")
    ...
    # Val-Data
    my_dataset_val = MyDatasetVal("./Dataset-CSV/Snap_Val_Pair_Label New.csv")
    ...
    for epoch in range(1, epochs + 1):
        ...
        # Save Model-Weight
        weight_folder_path = './Experiment/RankNet_Version 9_5&MobileNetV2&Epochs=100 Snap'
        save_path = weight_folder_path + '/RankNet+Snap+MobileNteV2+Epoch=' + str(epoch) + '.pth'
    ...
    train_loss_path = './Experiment/RankNet_Version 9_5&MobileNetV2&Epochs=100 Snap/' \
                      'Train-Snap Loss+MobileNteV2+RankNet.csv'
    ...
    train_acc_path = './Experiment/RankNet_Version 9_5&MobileNetV2&Epochs=100 Snap/' \
                     'Train-Snap Acc+MobileNteV2+RankNet.csv'
    ...
    val_loss_path = './Experiment/RankNet_Version 9_5&MobileNetV2&Epochs=100 Snap/' \
                    'Val-Snap Loss+MobileNteV2+RankNet.csv'
    ...
    val_acc_path = './Experiment/RankNet_Version 9_5&MobileNetV2&Epochs=100 Snap/' \
                   'Val-Snap Acc+MobileNteV2+RankNet.csv'
